function [diff_val_2, pos_fi, rot_error] = calc_base_target_orientation(pos_base_x, pos_base_y, pos_goal_x, pos_goal_y, rot_base)
...
% rot_error = abs(diff_val_2) + abs(rot_base)
